...
0. Скачать актуальную версию плагина  https://github.com/petrushin-a/gravi-wallet/raw/main/build/gravi-wal-plugin_v0.1.2.zip
...
### V.0.1.2
- убраны скрипты payouts (пул добавил функционал)

### V.0.1.3
- исправлен функционал по found (слетел из-за новой разметки)
